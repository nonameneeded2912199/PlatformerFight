        ...
        switch (enemy.thisDifficulty)
        {
            case GameDifficulty.EASY:
                ...
                enemy.BulletEventChannel.RaiseBulletEvent(entity.tag, attackPosition.position, bulletDetails[0].bulletSpeed, targetAngle, bulletDetails[0].bulletAcceleration,
                    bulletDetails[0].bulletLifeSpan, bulletDetails[0].damageMultiplier * enemy.CharacterStats.CurrentAttack / 2, 0.5f,
                    bulletDetails[0].bulletSprite, bulletDetails[0].animatorOverrideController);
                break;
            case GameDifficulty.NORMAL:
                enemy.BulletEventChannel.RaiseBulletEvent(entity.tag, attackPosition.position, bulletDetails[0].bulletSpeed, targetAngle, bulletDetails[0].bulletAcceleration,
                    bulletDetails[0].bulletLifeSpan, bulletDetails[0].damageMultiplier * enemy.CharacterStats.CurrentAttack, 0.5f,
                    bulletDetails[0].bulletSprite, bulletDetails[0].animatorOverrideController);
                break;
